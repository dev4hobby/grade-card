...
from app.user.permissions import get_current_active_user
from app.user.schemas import UserBaseInDb, UserCreate, UserInDb
...
async def update_user(
    pk: int, item: UserInDb, user: dict = Depends(get_current_active_user)
):
    """Update my profile"""
